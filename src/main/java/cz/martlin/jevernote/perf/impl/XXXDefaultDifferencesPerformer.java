...
public class XXXDefaultDifferencesPerformer extends BaseDifferencesPerformer {

	public XXXDefaultDifferencesPerformer(BaseStorage source, BaseStorage target) {
		super(source, target);
	}
